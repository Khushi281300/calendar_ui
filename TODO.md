...
- [ ] **Commit 12**: Add static Indian holiday markers to the grid.
- [ ] **Commit 13**: Add Vitest unit testing and `aria-labels` for Accessibility.
- [ ] **Commit 14**: Finalize `README.md` with instructions and a Lighthouse score.

*You can safely delete this file before your final submission!*
